...
一个互联网从业者，AI 应用探索者，产品经理，也写一点代码。

我从计算机科学出发，后来走向产品经理；不是离开技术，而是继续追问同一个问题：如何把一个想法变成真实可用的产品。编程、产品设计、AI Agent、端侧大模型，在我这里都指向同一件事：创造。

## 我在关注

- AI Agent 与 Vibe Coding：让 AI 不只是写代码，而是参与完整工作流。
